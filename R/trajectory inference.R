...
counts <- readMM("/Users/jiayiming/Desktop/麦吉尔暑研/scSTEM_sample_data/mouse_embryo_blood/counts_5k_final.mtx")
cell_meta <- read.csv("/Users/jiayiming/Desktop/麦吉尔暑研/scSTEM_sample_data/mouse_embryo_blood/cell_meta_5kgenes_final.csv")
gene_meta <- read.csv("/Users/jiayiming/Desktop/麦吉尔暑研/scSTEM_sample_data/mouse_embryo_blood/gene_meta_5kgenes_final.csv")
...
write.table(f, file = "mouse_embryo_neural.csv", sep = ",")
